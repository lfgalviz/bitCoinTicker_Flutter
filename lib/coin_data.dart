...
const apiKey = '180EFAA8-EAB9-41C3-9674-B5A060F42DFC';
...
class CoinData {
  ...
  CoinData(this.currency,this.virtualCoin);
  ...
  Future getCoinData() async {
    ...
    String requestURL = '$coinAPIURL/$virtualCoin/$currency?apikey=$apiKey';
